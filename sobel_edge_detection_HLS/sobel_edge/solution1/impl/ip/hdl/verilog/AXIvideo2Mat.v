...
reg   [0:0] exitcond_i_reg_434;
reg   [0:0] brmerge_i_reg_443;
...
reg   [31:0] t_V_3_reg_200;
reg   [0:0] eol_i_reg_211;
reg   [0:0] eol_reg_223;
reg   [23:0] axi_data_V_1_i_reg_234;
reg   [0:0] axi_last_V_3_i_reg_281;
reg   [23:0] axi_data_V_3_i_reg_293;
wire  signed [31:0] rows_V_fu_315_p1;
reg  signed [31:0] rows_V_reg_395;
reg    ap_block_state1;
wire  signed [31:0] cols_V_fu_319_p1;
reg  signed [31:0] cols_V_reg_400;
reg   [23:0] tmp_data_V_reg_405;
reg   [0:0] tmp_last_V_reg_413;
wire   [0:0] exitcond5_i_fu_332_p2;
wire    ap_CS_fsm_state4;
wire   [31:0] i_V_fu_337_p2;
reg   [31:0] i_V_reg_429;
wire   [0:0] exitcond_i_fu_343_p2;
wire    ap_block_state5_pp1_stage0_iter0;
reg    ap_predicate_op73_read_state6;
reg    ap_block_state6_pp1_stage0_iter1;
reg    ap_block_pp1_stage0_11001;
wire   [31:0] j_V_fu_348_p2;
reg    ap_enable_reg_pp1_iter0;
wire   [0:0] brmerge_i_fu_357_p2;
...
wire  signed [10:0] rows_V_fu_315_p0;
wire  signed [11:0] cols_V_fu_319_p0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond5_i_fu_332_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((exitcond_i_fu_343_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((exitcond5_i_fu_332_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_reg_434 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_343_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        sof_1_i_fu_98 <= 1'd0;
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_343_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if ((((eol_2_i_reg_270 == 1'd0) & (1'b0 == ap_block_pp2_stage0_11001) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_predicate_op73_read_state6 == 1'b1)) | ((1'b1 == AXI_video_strm_V_data_V_0_vld_out) & (1'b1 == ap_CS_fsm_state2)))) begin
...
always @ (*) begin
    if (((exitcond5_i_fu_332_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((1'b1 == ap_condition_529)) begin
        if ((brmerge_i_reg_443 == 1'd1)) begin
            ap_phi_mux_axi_last_V_2_i_phi_fu_250_p4 = eol_reg_223;
        end else if ((brmerge_i_reg_443 == 1'd0)) begin
...
always @ (*) begin
    if (((exitcond_i_reg_434 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((eol_2_i_reg_270 == 1'd0) & (1'b0 == ap_block_pp2_stage0) & (ap_enable_reg_pp2_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp2_stage0)) | ((brmerge_i_reg_443 == 1'd0) & (exitcond_i_reg_434 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op73_read_state6 == 1'b1)) | ((exitcond_i_reg_434 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_434 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_434 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op73_read_state6 == 1'b1)) | ((exitcond_i_reg_434 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_434 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_434 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = ((ap_enable_reg_pp1_iter1 == 1'b1) & (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op73_read_state6 == 1'b1)) | ((exitcond_i_reg_434 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_434 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_434 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0))));
end
...
always @ (*) begin
    ap_block_state6_pp1_stage0_iter1 = (((1'b0 == AXI_video_strm_V_data_V_0_vld_out) & (ap_predicate_op73_read_state6 == 1'b1)) | ((exitcond_i_reg_434 == 1'd0) & (img_data_stream_2_V_full_n == 1'b0)) | ((exitcond_i_reg_434 == 1'd0) & (img_data_stream_1_V_full_n == 1'b0)) | ((exitcond_i_reg_434 == 1'd0) & (img_data_stream_0_V_full_n == 1'b0)));
end
...
always @ (*) begin
    ap_condition_529 = ((exitcond_i_reg_434 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0));
end
...
always @ (*) begin
    ap_predicate_op73_read_state6 = ((brmerge_i_reg_443 == 1'd0) & (exitcond_i_reg_434 == 1'd0));
end

assign ap_ready = internal_ap_ready;

assign brmerge_i_fu_357_p2 = (sof_1_i_fu_98 | ap_phi_mux_eol_i_phi_fu_215_p4);

assign cols_V_fu_319_p0 = img_cols_V_dout;

assign cols_V_fu_319_p1 = cols_V_fu_319_p0;

assign exitcond5_i_fu_332_p2 = ((t_V_reg_189 == rows_V_reg_395) ? 1'b1 : 1'b0);

assign exitcond_i_fu_343_p2 = ((t_V_3_reg_200 == cols_V_reg_400) ? 1'b1 : 1'b0);

assign i_V_fu_337_p2 = (t_V_reg_189 + 32'd1);
...
assign j_V_fu_348_p2 = (t_V_3_reg_200 + 32'd1);

assign rows_V_fu_315_p0 = img_rows_V_dout;

assign rows_V_fu_315_p1 = rows_V_fu_315_p0;
