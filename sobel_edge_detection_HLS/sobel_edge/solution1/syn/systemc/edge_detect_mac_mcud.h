...
#ifndef __edge_detect_mac_mcud__HH__
#define __edge_detect_mac_mcud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(edge_detect_mac_mcud) {
    ...
    SC_CTOR(edge_detect_mac_mcud):  simcore_mac_0_U ("simcore_mac_0_U") {
