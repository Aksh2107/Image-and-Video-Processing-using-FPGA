...
#ifndef __edge_detect_mul_mbkb__HH__
#define __edge_detect_mul_mbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(edge_detect_mul_mbkb) {
    ...
    SC_CTOR(edge_detect_mul_mbkb):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
