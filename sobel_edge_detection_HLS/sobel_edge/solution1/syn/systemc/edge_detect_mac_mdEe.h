...
#ifndef __edge_detect_mac_mdEe__HH__
#define __edge_detect_mac_mdEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(edge_detect_mac_mdEe) {
    ...
    SC_CTOR(edge_detect_mac_mdEe):  simcore_mac_1_U ("simcore_mac_1_U") {
