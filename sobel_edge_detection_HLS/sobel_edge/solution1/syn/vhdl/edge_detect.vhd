...
architecture behav of edge_detect is 
    ...
    "edge_detect,hls_ip_2018_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z010clg400-1,HLS_INPUT_CLOCK=13.500000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=12.563000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=9,HLS_SYN_DSP=3,HLS_SYN_FF=1355,HLS_SYN_LUT=3387}";
